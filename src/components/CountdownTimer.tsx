  ...
  return (
    ...
    >
      ...
      <div className="mt-7 pt-6 border-t border-amber-300/60 flex flex-col items-center">
        ...
        {attendance === 'yes' && (
          <div className="mt-3.5 px-4 py-2 rounded-xl bg-emerald-50 border border-emerald-300 text-emerald-800 text-xs sm:text-sm font-sans-ui text-center animate-fadeIn shadow-sm flex items-center gap-2">
            <span>✨</span>
            <span>
              <strong>Alhamdulillah!</strong> We are delighted and honorably look forward to celebrating with you!
            </span>
          </div>
        )}

        {attendance === 'no' && (
          <div className="mt-3.5 px-4 py-2 rounded-xl bg-rose-50/90 border border-rose-200 text-stone-700 text-xs sm:text-sm font-sans-ui text-center animate-fadeIn shadow-sm flex items-center gap-2">
            <span>🤍</span>
            <span>
              You will be dearly missed. Please keep Dr. Fathima &amp; Anas in your sincere prayers!
            </span>
          </div>
        )}
      </div>
